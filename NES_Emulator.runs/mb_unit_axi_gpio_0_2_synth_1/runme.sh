...
HD_PWD='C:/Users/carri/ECE_385/NES_Emulator/NES_Emulator.runs/mb_unit_axi_gpio_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_unit_axi_gpio_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_unit_axi_gpio_0_2.tcl
