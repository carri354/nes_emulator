...
HD_PWD='C:/Users/carri/ECE_385/NES_Emulator/NES_Emulator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nes_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nes_top.tcl -notrace
