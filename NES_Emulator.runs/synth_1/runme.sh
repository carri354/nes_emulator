...
HD_PWD='C:/Users/carri/ECE_385/NES_Emulator/NES_Emulator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nes_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nes_top.tcl
