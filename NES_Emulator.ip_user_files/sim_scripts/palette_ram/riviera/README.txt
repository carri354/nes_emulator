...
#
# Generated by export_simulation on Thu Apr 16 01:31:14 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './palette_ram.sh' script.

./palette_ram.sh -reset_run
...
./palette_ram.sh -noclean_files

For more information on the script, please type './palette_ram.sh -help'.
