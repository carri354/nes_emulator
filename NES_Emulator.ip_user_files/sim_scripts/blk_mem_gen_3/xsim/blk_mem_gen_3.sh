...
#
# Generated by Vivado on Thu Apr 16 20:49:13 -0500 2026
...
simulate()
{
  xsim  blk_mem_gen_3 -key {Behavioral:sim_1:Functional:blk_mem_gen_3} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_unit.protoinst" -log simulate.log
}
