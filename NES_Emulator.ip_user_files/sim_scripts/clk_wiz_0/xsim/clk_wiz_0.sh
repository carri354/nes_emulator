...
#
# Generated by Vivado on Tue Apr 14 19:08:05 -0500 2026
...
simulate()
{
  xsim  clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_unit.protoinst" -log simulate.log
}
